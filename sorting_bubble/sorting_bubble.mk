...
ProjectPath            :=C:/Users/deepjal/Documents/Documents/sorting_bubble
...
$(OutputFile): ../build-$(ConfigurationName)/sorting_bubble/.d $(Objects) 
	@if not exist "..\build-$(ConfigurationName)\sorting_bubble" mkdir "..\build-$(ConfigurationName)\sorting_bubble"
...
../build-$(ConfigurationName)/sorting_bubble/main.cpp$(ObjectSuffix): main.cpp ../build-$(ConfigurationName)/sorting_bubble/main.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/deepjal/Documents/Documents/sorting_bubble/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
