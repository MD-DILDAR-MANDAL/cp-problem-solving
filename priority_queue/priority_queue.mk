...
ProjectPath            :=C:/Users/deepjal/Documents/GitHub/practice-programs/priority_queue
...
../build-$(ConfigurationName)/priority_queue/main.cpp$(ObjectSuffix): main.cpp ../build-$(ConfigurationName)/priority_queue/main.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/deepjal/Documents/GitHub/practice-programs/priority_queue/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
